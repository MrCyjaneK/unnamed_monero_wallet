...
curl https://static.mrcyjanek.net/monero_c/$(./get_current_build.sh)/aarch64-linux-sailfishos_libwallet2_api_c.so.xz --output $PWD/build/elinux/arm64/release/bundle/lib/libwallet2_api_c.so.xz
